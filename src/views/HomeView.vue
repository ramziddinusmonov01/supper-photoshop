<template>
    ...
    <nav class="nav">
      <div class="nav-container">
        <a href="#" class="nav-logo__link">
          <img class="nav-logo" src="@/assets/images/logo-light.png" alt="logo">
        </a>
    ...
    <div class="container">
      ...
      <div class="using">
        ...
        <swiper class="using-info__slide" :modules="modules" :slides-per-view="1" :space-between="20" loop="true"
          ...
          <swiper-slide class="using-slide__item" v-for="usingInfoImg in store.usingImg?.data" :key="usingInfoImg.id">
            <div class="using-slide-item__img">
      ...
      <div class="author" :id="store.navbar[2].category_name">
        ...
        <div class="author-imgs">
          <swiper class="author-imgs__swiper" :modules="modules" :slides-per-view="1" :space-between="20" loop="true"
            :autoplay="{
              delay: 3000,
            }">
            <swiper-slide class="author-swiper__slide" v-for="authorInfoImg in store.authorImg?.data"
              :key="authorInfoImg.id">
      ...
      <div class="comments" :id="store.navbar[3].category_name">
        <h1 class="comments-title" id="OquvchilarFikri">O`quvchilar fikrlari</h1>
        ...
        <swiper class="media-list " :slides-per-view="1" :space-between="30" :pagination="{ clickable: true }"
          :modules="modules" :autoplay="{
            delay: 3000,
          }">
          <swiper-slide class="comments-list__item" v-for="comments in store.pupilComenents?.data.items"
            :key="comments.id">     
              <img class="comments-item__img" :src="comments.image" alt="img">
            <div class="comments-item__info">
  ...
  <div class="linear" v-if="linear" @click="linearClose"></div>
</template>
...
function updateModalTopicItem(i){
  modalTopicItemData.value = store.photoShopThemes?.data.items[i].description;
